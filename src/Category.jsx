                ...
                {categories.map((category) => {
                    ...
                    return (
                        <div key={category} className="bg-black w-full mb-6">
                            <div className="p-4">
                                <h2 id={category} className="text-2xl font-semibold text-white">{category} Games</h2>
                            </div>
                                            ...
                                            <div className="p-4 bg-black text-white">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <div className="flex items-center space-x-2">
                                                        ...
                                                        <button
                                                            onClick={() => gameNav(game.id)}

                                                            className="bg-yellow-500 hover:bg-yellow-600 text-black px-4 py-2 rounded-full text-sm transition-colors"
                                                        >
                                                            Buy
                                                        </button>
